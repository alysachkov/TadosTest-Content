namespace Content.WebApi.Controllers.Content
{
    ...
    public class ContentController : ContentApiControllerBase
    {
        ...
        public Task<IActionResult> CreateContent(ContentCreateHierarchicRequest request)
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public Task<IActionResult> EditContent(ContentEditHierarchicRequest request) =>
